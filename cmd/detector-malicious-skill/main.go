// detector-malicious-skill reads events JSONL from stdin and emits findings
// JSONL to stdout for skill-related events that contain suspicious URLs,
// encoded payloads, or excessive permission requests.
//
// Usage:
//
//	detector-malicious-skill --baseline <path> < events.jsonl
package main
