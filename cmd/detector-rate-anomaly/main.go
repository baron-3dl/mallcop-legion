// detector-rate-anomaly reads events JSONL from stdin and emits findings
// JSONL to stdout for events that show API rate anomalies: burst requests,
// orders-of-magnitude jumps above baseline, or unusual endpoint access patterns.
//
// Usage:
//
//	detector-rate-anomaly --baseline <path> < events.jsonl
package main
